!(function(t, e) {
  'object' == typeof exports && 'object' == typeof module
    ...
    ? define('vue-slider-component', [], e)
    : 'object' == typeof exports
    ? (exports['vue-slider-component'] = e())
    : (t['vue-slider-component'] = e())
})(this, function() {
  return (function(t) {
    function e(s) {
    ...
    function(t, e, i) {
      ...
      e.default = {
        ...
        computed: {
          ...
          tooltipMergedPosition: function() {
            ...
            if (this.$refs.dot0) {
              ...
              var i = {}
              return (
                (i[t] = '-' + (this.dotWidthVal / 2 - this.height / 2 + 9) + 'px'),
                (i.left = '50%'),
                i
              )
            }
              ...
              ? this.isFixed
                ? [
                    [
                      this.minimum,
                      this.maximum -
                        (this.fixedValue * (this.spacing * this.multiple)) / this.multiple,
                    ],
                    [
                      this.minimum +
                        (this.fixedValue * (this.spacing * this.multiple)) / this.multiple,
          ...
          piecewiseDotWrap: function() {
            ...
            for (var t = [], e = 0; e <= this.total; e++) {
              ...
              ;(this.piecewiseFilter && !this.piecewiseFilter({ index: s, label: r })) ||
                t.push({ style: i, index: s, label: this.formatter ? this.formatting(r) : r })
            }
            return t
          },
        },
        ...
        methods: {
          bindEvents: function() {
            document.addEventListener('touchmove', this.moving, { passive: !1 }),
              document.addEventListener('touchend', this.moveEnd, { passive: !1 }),
          ...
          changeFocusSlider: function(t) {
            ...
            if (this.isRange) {
              ...
              i[0] > i[1] &&
                ((this.focusSlider = 0 === this.focusSlider ? 1 : 0), (i = i.reverse())),
                this.setIndex(i)
          ...
          mergeFormatting: function(t, e) {
            return 'string' == typeof this.mergeFormatter
              ? this.mergeFormatter.replace(/\{(value1|value2)\}/g, function(i, s) {
                  return 'value1' === s ? t : e
                })
          ...
          wrapClick: function(t) {
            ...
            if (this.isRange)
              if (
                ...
                this.currentSlider =
                  i > (this.position[1] - this.position[0]) / 2 + this.position[0] ? 1 : 0
              ...
              if (((this.currentSlider = e), i)) {
                ...
                ;(this.processFlag = !0),
                  (this.processSign = {
                    pos: this.position,
                    start: this.getPos(
                      t.targetTouches && t.targetTouches[0] ? t.targetTouches[0] : t,
                    ),
                  })
              }
              this.enableCross || this.val[0] !== this.val[1] || (this.crossFlag = !0)
            }
            !i && this.useKeyboard && ((this.focusFlag = !0), (this.focusSlider = e)),
              (this.flag = !0),
          ...
          moving: function(t) {
            ...
            t.preventDefault(),
              ...
              this.processFlag
                ? ((this.currentSlider = 0),
                  this.setValueOnPos(
                    this.processSign.pos[0] + this.getPos(t) - this.processSign.start,
                    !0,
                  ),
                  (this.currentSlider = 1),
                  this.setValueOnPos(
                    this.processSign.pos[1] + this.getPos(t) - this.processSign.start,
                    !0,
                  ))
          ...
          moveEnd: function(t) {
            ...
            this.$emit('drag-end', this),
              this.lazy && this.isDiff(this.val, this.value) && this.syncValue(),
              (this.flag = !1),
            ...
            if (t >= i[0] && t <= i[1]) {
              ...
              this.setTransform(t),
                ...
                this.isRange &&
                  ...
                  (this.setTransform(
                    t + this.fixedValue * this.gap * (0 === this.currentSlider ? 1 : -1),
                    !0,
                  ),
              ...
              this.setTransform(i[n]),
                ...
                this.isRange && (this.fixed || this.isLessRange(t, r))
                  ? (this.setTransform(this.limit[this.idleSlider][n], !0),
                    this.setCurrentValue(this.valueLimit[this.idleSlider][n], e, !0))
                  : !this.isRange ||
          ...
          isLessRange: function(t, e) {
            ...
            var i = 0 === this.currentSlider ? this.currentIndex[1] - e : e - this.currentIndex[0]
          ...
          setCurrentValue: function(t, e, i) {
            ...
            this.isRange
              ? this.isDiff(this.currentValue[s], t) &&
                ...
                (this.lazy && this.flag && !this.keydownFlag) || this.syncValue())
          ...
          getIndexByValue: function(t) {
            return this.data
              ? this.data.indexOf(t)
              : Math.round((t - this.minimum) * this.multiple) / (this.spacing * this.multiple)
          },
          setIndex: function(t) {
            if (Array.isArray(t) && this.isRange) {
              ...
              (t = this.getValueByIndex(t)),
                this.isRange &&
                  (this.currentSlider =
                    t > (this.currentValue[1] - this.currentValue[0]) / 2 + this.currentValue[0]
                      ? 1
                      : 0),
          ...
          setPosition: function(t) {
            this.flag || this.setTransitionTime(void 0 === t ? this.speed : t),
              this.isRange
                ? (this.setTransform(this.position[0], 1 === this.currentSlider),
                  this.setTransform(this.position[1], 0 === this.currentSlider))
          ...
          setTransform: function(t, e) {
            var i = e ? this.idleSlider : this.currentSlider,
              ...
              n = this.fixed
                ...
                : (0 === i ? this.position[1] - t : t - this.position[0]) + 'px',
              l = this.fixed
              ...
              ? ((this.slider[i].style.transform = o),
                ...
                'vertical' === this.direction
                  ? ((this.$refs.process.style.height = n),
                    (this.$refs.process.style[this.reverse ? 'top' : 'bottom'] = l))
                  : ((this.$refs.process.style.width = n),
                    (this.$refs.process.style[this.reverse ? 'right' : 'left'] = l)))
          ...
          refresh: function() {
            this.$refs.elem &&
              (this.getStaticData(), this.computedFixedValue(), this.setPosition(0))
          },
          ...
          handleOverlapTooltip: function() {
            ...
            if (this.isRange && t) {
              ...
              d || u ? this.handleDisplayMergedTooltip(!0) : this.handleDisplayMergedTooltip(!1)
            }
          },
        ...
        mounted: function() {
          ...
          this.$nextTick(function() {
            t.isComponentExists &&
              (t.getStaticData(),
              t.setValue(t.limitValue(t.value), !0, t.startAnimation ? t.speed : 0),
              t.bindEvents(),
              t.isRange &&
                t.tooltipMerge &&
                !t.startAnimation &&
                                ...
                                i('div', {
                                  ...
                                  style: [
                                    !t.boolDisabled && t.disabledArray[0]
                                      ...
                                      : null,
                                    t.sliderStyles[0],
                                    t.focusFlag && 0 === t.focusSlider ? t.focusStyles[0] : null,
                                  ],
                                }),
                              ],
                              { value: t.val[0], index: 0, disabled: t.disabledArray[0] },
                            ),
                            t._v(' '),
                            i(
                              'div',
                                ...
                                i('div', {
                                  ...
                                  style: [
                                    !t.boolDisabled && t.disabledArray[1]
                                      ...
                                      : null,
                                    t.sliderStyles[1],
                                    t.focusFlag && 1 === t.focusSlider ? t.focusStyles[1] : null,
                                  ],
                                }),
                              ],
                              { value: t.val[1], index: 1, disabled: t.disabledArray[1] },
                            ),
                            t._v(' '),
                            i(
                              'div',
                              {
                                ref: 'tooltip1',
                                class: [
                                  'vue-slider-tooltip-' + t.tooltipDirection[1],
                                  'vue-slider-tooltip-wrap',
                                ],
                              },
                              [
                        ...
                        void 0 !== t.staticValue
                          ? i(
                              ...
                              [
                                t._t(
                                  'static-dot',
                                  [i('div', { staticClass: 'vue-slider-dot-handle--static' })],
                                  { value: t.staticValue },
                                ),
                                t._v(' '),
                                t.val !== t.staticValue
                                  ? i(
                                      ...
                                      {
                                        class: [
                                          'vue-slider-tooltip-' + t.tooltipDirection,
                                          'vue-slider-tooltip-wrap',
                                        ],
                                      },
                                      [
                            ...
                            t._t(
                              ...
                              [
                                i('div', {
                                  ...
                                  style: [
                                    t.sliderStyles,
                                    t.focusFlag && 0 === t.focusSlider ? t.focusStyles : null,
                                  ],
                                }),
                              ],
                              ...
                              t.piecewise
                                ? i('span', {
                                    class: [
                                      ...
                                      { 'vue-slider-piecewise-dot-active': t.isActive(e.index) },
                                    ],
                                    style: [
                                      t.piecewiseStyle,
                                      t.isActive(e.index) ? t.piecewiseActiveStyle : null,
                                    ],
                                  })
                                : t._e(),
                            ],
                              ...
                              t.piecewiseLabel
                                ? i(
                                    'span',
                                    {
                                      ...
                                      style: [
                                        t.labelStyle,
                                        t.isActive(e.index) ? t.labelActiveStyle : null,
                                      ],
                                    },
                                    [t._v('\n            ' + t._s(e.label) + '\n          ')],
                                  )
                                ...
                                [
                                  t._v(
                                    '\n            ' +
                                      t._s(
                                        t.mergeFormatter
                                          ? t.mergeFormatting(t.val[0], t.val[1])
                                          : t.formatter
                                          ? t.val[0] === t.val[1]
    ...
    function(t, e, i) {
      ...
      function o(t) {
        var e,
          i,
          s = document.querySelector('style[data-vue-ssr-id~="' + t.id + '"]')
        if (s) {
          if (f) return v
      ...
      t.exports = function(t, e) {
        for (var i = [], s = {}, r = 0; r < e.length; r++) {
          var o = e[r],
            ...
            a = o[2],
            d = o[3],
            u = { id: t + ':' + r, css: l, media: a, sourceMap: d }
          s[n] ? s[n].parts.push(u) : i.push((s[n] = { id: n, parts: [u] }))
        }
        return i
      }
    },
