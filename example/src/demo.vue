<template>
	<div class="container">
		...
		<section data-title="Vertical + Custom Class" id="demo5">
			<div>
				<vue-slider ref="slider5" v-bind="demo.demo5" v-model="demo.demo5.value" :formatter="formatting" :reverse="true" tooltipDir="left" @drag-start="dragStart" @drag-end="dragEnd" @callback="d"></vue-slider>
				<vue-slider ref="slider5" v-bind="demo.demo5" v-model="demo.demo5.value" :formatter="formatting" :reverse="false" tooltipDir="right" @drag-start="dragStart" @drag-end="dragEnd" @callback="d"></vue-slider>
